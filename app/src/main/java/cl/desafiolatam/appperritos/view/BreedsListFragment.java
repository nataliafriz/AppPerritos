...
import cl.desafiolatam.appperritos.api.Api;
 ...
 * Use the {@link BreedsListFragment#newInstance} factory method to
...
public class BreedsListFragment extends Fragment {
    ...
    public static BreedsListFragment newInstance(String param1, String param2) {
        BreedsListFragment fragment = new BreedsListFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recyclerBreeds);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext(),RecyclerView.VERTICAL, false));
        recyclerView.setHasFixedSize(true);

        final List<String> breedsOfList = new Repository().loadInfo();
       // adapter = new BreedsAdapter(breedsOfList,getContext());
    }
}